...
public class ConstructableObjectManager : MonoBehaviour
{
    ...
    public void CreateBuildableForObject(Vector2Int coords, Vector3 pos)
    {
        ...
        WorldChunkManager.Instance.Chunks[chunk.x, chunk.y].AddConstructable(new BuildableStructure(coords.x, coords.y, buildingData.TimeToBuild, false, OnBuilt, buildingData.Size(),default,ConstructableType.Furniture,buildingData.Name));
